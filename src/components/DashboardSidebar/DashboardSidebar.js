            ...
            <div className="dashboard-sidebar__content">
                <nav className="dashboard-nav">
                    ...
                    <Link className={`dashboard-nav__item ${isLinkSelected('/log') ? 'selected' : ''}`} to="/log">
                        <div className="dashboard-nav__icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M20 18H4M14.5 12H4M20 6H4" stroke="#D2D4D7" stroke-width="2" stroke-linecap="round"/>
                            </svg>
                        </div>
                    ...
                    <Link className={`dashboard-nav__item ${isLinkSelected('/info') ? 'selected' : ''}`} to="/info">
                            <div className="dashboard-nav__icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12 12.0001L12 16.5M12 8.66462V8.62507M3 17.625L3 6.37498C3 4.51103 4.51104 3 6.375 3L17.625 3C19.489 3 21 4.51103 21 6.37498L21 17.625C21 19.489 19.489 21 17.625 21H6.375C4.51104 21 3 19.489 3 17.625Z" stroke="#D2D4D7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </div>
